...
describe('Word Analyzer', () => {
    test('should return chapter1.txt content', () => {
        expect(Analyzer.readTextFile('Week2/Day1/05-Word-Analysis/chapter1.txt')).toEqual(content)
    })

    test('should return total number of words', () => {
        expect(Analyzer.countWords(content)).toEqual(3076)
    })

    test('should return top 5 words', () => {
        expect(Analyzer.top5Words(content)).toEqual(["bran", "father", "jon", "robb", "man"])
    })
